...
import supabaseIcon from '../../assets/icons/supabase-logo-icon.webp'
...
const estiloButtonProjectCard = 'border rounded-sm w-4/5 py-2 px-8 text-sm shadow-md bg-emerald-300 hover:bg-emerald-200 active:bg-emerald-100 duration-200 ease-in-out cursor-pointer text-center items-center'
const estiloStackSectionProjectCard = 'flex gap-12 items-center justify-between mb-8'

export function ProjectCardDM ( {titleProjectCard, descriptionProjectCard}:ProjectCardProps ) {
    return (
