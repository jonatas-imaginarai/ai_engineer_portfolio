...
const estiloCTAHeroButtonDownload = 'border border-gray-400 px-12 py-2 rounded-xs hover:bg-blue-200 active:bg-blue-100 cursor-pointer duration-200 ease-in-out'
